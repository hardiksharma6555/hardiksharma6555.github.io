        ...
        <div className="relative">
          ...
          <AnimatedList className="space-y-8">
            {experiences.map((exp, i) => (
              <AnimatedItem key={i} className="relative pl-16">
                ...
                <div className="bg-card border border-border rounded-xl p-6 hover:border-primary/30 transition-all">
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-4">
                    <div>
                      ...
                      <p className="text-blue-600 dark:text-blue-300 font-medium text-sm">{exp.company}</p>
                    ...
                    <span className={`text-xs font-medium px-2.5 py-1 rounded-full border whitespace-nowrap ${
                      exp.current
                        ? 'bg-blue-600/15 text-blue-600 dark:text-blue-300 border-blue-600/30'
                  ...
                  <div className="flex flex-wrap gap-2">
                    {exp.tags.map((tag) => (
                      <span
                        key={tag}
                        className="px-2 py-0.5 rounded text-xs font-medium bg-blue-600/10 text-blue-600 dark:text-blue-400 border border-blue-600/20"
                      >
                        {tag}
                      </span>
                    ))}
